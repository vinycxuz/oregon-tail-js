...
class Cliente {
    constructor(idCliente, tipoCliente, dataCriacao, 
        codBanco, agencia, conta, saldo) {
...
class Pessoa extends Cliente {
    constructor(idCliente, tipoCliente, dataCriacao, 
        codBanco, agencia, conta, saldo, nome, 
            cpf, email, telefone, dataDeNascimento){
            super(idCliente, tipoCliente, dataCriacao, 
                codBanco, agencia, conta, saldo)
            this.nome = nome
            this.cpf = cpf
            this.email = email
...
class Empresa extends Cliente {
    constructor(idCliente, tipoCliente, dataCriacao, 
        codBanco, agencia, conta, saldo, nomeFantasia,
        cnpj, email, telefone, dataDeNascimento){
            super(idCliente, tipoCliente, dataCriacao, 
                codBanco, agencia, conta, saldo)
...
class Transacao {
    static transferencia(contaOrigem, contaDestino, 
        idTransacao, dataDeTransacao, valorDaTransferencia){
    ...
    static deposito(contaDestino, idDeposito, dataDoDeposito, 
        valorDoDeposito) {
    ...
    static pagamentoSalario(contaOrigem, contaDestino, 
        idPagamento, dataDoPagamento, valorDoSalario) {
...
const ChurrosVictor = new Empresa(
  ...
  console.log(ChurrosVictor.saldo); // Deve retornar 1050
  ...
  console.log(Maria.historico); // Deve retornar [{idPagamento: 006, dataDoPagamento: "22/12/2022", valorDaSalario: 500, tipo: "pagamento"}]
  console.log(Joao.historico[1]); // Deve retornar [{idPagamento: 006, dataDoPagamento: "22/12/2022", valorDaSalario: 500, tipo: "recebimento"}]